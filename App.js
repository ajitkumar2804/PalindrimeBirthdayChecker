...
function clickHandler(e) {
    ...
    if (bdayString !== "") {
      ...
      if (!isPalindrome) {
        ...
        if (ctr1 > ctr2) {
          resultDiv.innerText = `The Nearest Palidrome Date is ${prevDate.day}-${prevDate.month}-${prevDate.year}, You Missed It BY ${ctr2} Days`;
        } else {
          resultDiv.innerText = `The Nearest Palidrome Date is ${nextDate.day}-${nextDate.month}-${nextDate.year}, You Missed It BY ${ctr1} Days`;
        }
      } else {
